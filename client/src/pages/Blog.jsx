  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border
        -primary/35 bg-primary/5 font-medium text-primary'>Michael Brown</p>
      </div>
      
      <div className='mx-5 max-w-5xl md:mx-auto my-10mt-6'>
          ...
          <div className='flex flex-col gap-4'>
            {comments.map((item,index)=>(
             ...
             max-w-xl p-4 rounded text-gray-600'>
              ...
              <p className='tex-sm max-w-md ml-8'>{item.content}</p>
