...
const BlogList = () => {
  ...
  return (
    <div>
      <div className='flex justify-center gap-4 sn:gap-8 my-10 relative'>
      ...
      gap-8 mb-24 mx-8 sm:mx-16 xl:mx-40'>
        {filteredBlogs().filter((blog)=> menu === "All" ? true : blog.category ===
        menu).map((blog)=> <BlogCard key={blog._id} blog={blog}/>)}
      </div>
    </div>
  )
}
